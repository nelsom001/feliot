...
export const VIPDRINKSMENU = [
  ...
  },
  {
    ...
    data: [
      ...
      { name: "TURBORKING", price: 2500 },
      { name: "SMALL SMIRNOFF ICE", price: 2000 },
      ...
      { name: "BUDWEISER", price: 2500 },
      { name: "CASTLE LITE", price: 2000 },
      { name: "FLYING FISH", price: 2000 },
      { name: "BIG SMIRNOFF ICE", price: 2500 },
      { name: "BOTTLE ORLJIN", price: 2000 },
    ],
  },
];
